...
def ORPO_train(args, output_dir):
    ...
    # TODO: utils.YOUR_CODE_HERE
    model, tokenizer = FastLanguageModel.from_pretrained(args.model_name, load_in_4bit=True)
    ...
    # TODO: utils.YOUR_CODE_HERE
    model = FastLanguageModel.get_peft_model(model, lora_dropout=args.dropout)
